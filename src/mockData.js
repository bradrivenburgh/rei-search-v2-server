...
const fakeProps = [
  ...
  },
  {
    ...
    photos: [
      `https://maps.googleapis.com/maps/api/streetview?size=1025x768&location=39.98567199707031,-75.1126937866211&key=${STREETVIEW_API_KEY}&signature=${STREETVIEW_SIGNATURE}`,
    ],
  },
  {
    address: {
